...
NAMENODE_PORTS1='500475:tcp 8480:tcp 8485:tcp'


NEW_PORTS="$AMBARI_CLIENT_PORT $YARN_PORTS $ZOOKEEPER_PORTS $MAPREDUCE_PORTS $NAMENODE_PORTS $NAMENODE_PORTS1"

echo "$GLUSTER_PORTS $AMBARI_PORTS $HADOOP_PORTS $NEW_PORTS"
