#!/bin/bash
#
# gen_ports.sh outputs a tuple of ports used by gluster, ambari, and support
# hadoop services. The format is: "port#[:protocol] ...", where port# can be
# a range defined as x-z. The default protocal is tcp.

#GLUSTER_PORTS='20047-20048 49152-49170 111 111:udp 38465-38467'
GLUSTER_PORTS='111 111:udp 24007 24009-24108 34865-34867 50152-50251'
...
NAMENODE_PORTS='8020 9000 50070 50470 50090 50010 50020 50075 8010'
NAMENODE_PORTS+=' 50475 8480 8485'
